...
async function getStyleMap(url, isMobile, login) {
  ...
  if (login) {
    await page.goto('http://0.0.0.0/w/Special:Login', {
...
const pages = [
  ...
  'w/Special:%EB%AA%A8%EB%93%A0%EB%AC%B8%EC%84%9C', // 특수:모든문서
  ...
  'w/Special:%EC%A0%91%EB%91%90%EC%96%B4%EC%B0%BE%EA%B8%B0', // 특수:접두어찾기
  'w/Special:%EC%A0%9C%EB%AA%A9%EB%B3%84%ED%95%AD%EB%AA%A9', // 특수:제목별항목
  'w/Special:%EC%A0%9C%EC%9E%AC%EC%95%88%EB%AA%A9%EB%A1%9D', // 특수:제재안목록
